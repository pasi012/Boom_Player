...
import inc.sltechnology.boomplayer.databinding.ModalRvBinding
import inc.sltechnology.boomplayer.databinding.SleeptimerItemBinding
...
import inc.sltechnology.boomplayer.preferences.AccentsAdapter
import inc.sltechnology.boomplayer.preferences.ActiveTabsAdapter
import inc.sltechnology.boomplayer.preferences.FiltersAdapter
import inc.sltechnology.boomplayer.preferences.NotificationActionsAdapter
import inc.sltechnology.boomplayer.ui.ItemSwipeCallback
import inc.sltechnology.boomplayer.ui.ItemTouchCallback
            ...
            when (sheetType) {
                ...
                FILTERS_TYPE -> {
                    ...
                    btnPositive.setOnClickListener {
                        ...
                        updatedItems.takeIf { it != mPreferences.filters}?.let { updatedList ->
                            mPreferences.filters = updatedList
                            mUIControlInterface.onAppearanceChanged(isThemeChanged = false)
                            return@setOnClickListener
                        }
                        dismiss()
                ...
                NOTIFICATION_ACTIONS_TYPE -> {
                    ...
                    ItemTouchHelper(ItemSwipeCallback(isQueueDialog = false, isFavoritesDialog = true) {
                        ...
                        if (direction == ItemTouchHelper.RIGHT) {
                            mMediaControlInterface.onAddToQueue(mPreferences.favorites?.get(index))
