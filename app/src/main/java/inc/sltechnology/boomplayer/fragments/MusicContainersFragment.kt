...
import inc.sltechnology.boomplayer.databinding.FragmentMusicContainersBinding
...
import inc.sltechnology.boomplayer.extensions.loadWithError
import inc.sltechnology.boomplayer.extensions.setTitleColor
import inc.sltechnology.boomplayer.extensions.waitForCover
...
class MusicContainersFragment : Fragment(),
    ...
    private val sIsFastScrollerPopup get() = mSorting == Constants.ASCENDING_SORTING || mSorting == Constants.DESCENDING_SORTING
