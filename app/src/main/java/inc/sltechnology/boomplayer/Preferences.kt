...
class Preferences(context: Context) {
    ...
    var onListEnded
        get() = mPrefs.getString("on_list_ended_pref", Constants.CONTINUE)
    ...
    var songsVisualization
        get() = mPrefs.getString("song_visual_pref", Constants.FN)
    ...
    var notificationActions: NotificationAction
        get() = getObjectForType("notification_actions_pref", NotificationAction::class.java)
            ?: NotificationAction(Constants.REPEAT_ACTION, Constants.CLOSE_ACTION)
    ...
    var playbackSpeedMode
        get() = mPrefs.getString("playback_vel_pref", Constants.PLAYBACK_SPEED_ONE_ONLY)
